...
class gsp_eduTrust_sendemailindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sendemail/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('textArea','g',41,['rows':("15"),'cols':("40"),'name':("message"),'class':("form-control"),'placeholder':("Enter your message here")],-1)
printHtmlPart(11)
createClosureForHtmlPart(12, 2)
invokeTag('actionSubmit','g',45,['class':("btn btn-success"),'value':("Send Email"),'action':("sendEmail")],2)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1412057448767L
